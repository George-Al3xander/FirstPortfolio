...
const DisplayProjects = ({projects}) => {
    return(
        ...
        {projects.map(() => {
            ...
            <img src="./src/assets/images/Screenshot_24.png" alt="Project photo" />
            <div className="project-content">
              <h2>Project name <span className="project-links">
                <a target="_blank" href="https://github.com/George-Al3xander">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium, incidunt maiores? Magnam temporibus esse inventore cum libero doloremque aliquid quam?</p>
            </div>
          </li>
        })}
        </>

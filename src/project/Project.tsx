...
const Project = ({project}: {project: project}) => {
    ...
    return(<li draggable onClick={() => {
        window.open(project.url_preview)
      }} key={project.id} className="project">
      <img src={project.img} alt={project.name} />
      <div className="project-content">
        <h2>{project.name} 
        <span onClick={(e) => e.stopPropagation()} className="project-links">
          <a target="_blank" href={project.url_github}>
        ...
        <a target="_blank" href={project.url_preview}>
